...
> analisis 0.16.0 hanya membaca snapshot secara offline dan bukan versi yang
...
konfigurasi historis saat eksperimen dijalankan. Kebijakan kandidat 0.16.0 saat
...
- Klaim nol pelanggaran SOC berasal dari simulasi itinerary pada 0.10.0.
  Rekonsiliasi SOC berdasarkan setiap leg Compute Routes final pada 0.16.0 belum
