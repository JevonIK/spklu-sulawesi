...
> analisis 0.17.0 tidak menjalankan ulang request tersebut dan tidak boleh
...
0.17.0 tidak dapat dibuktikan hanya dari laporan historis.
...
historis dijalankan. Kebijakan kandidat 0.17.0 saat ini memakai 100 Compute
...
- Klaim nol pelanggaran SOC berasal dari simulasi itinerary pada implementasi
  0.9.2. Validasi ulang per-leg Compute Routes final yang tersedia di 0.17.0
